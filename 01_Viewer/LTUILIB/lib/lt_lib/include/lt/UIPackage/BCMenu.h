...
{
	class BCMenuData;
	class LT_LIB_CLASS BCMenu : public CMenu
	{
	...
	public:
		...
		BOOL LoadToolbar(UINT nToolBar, UINT nToolbarBitmp = 0);
		BOOL LoadToolbars(const UINT *arID, int n, const UINT *arBitmapID = NULL);
